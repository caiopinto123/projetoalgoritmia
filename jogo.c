...
//FIIM DAS NOVAS FUNÇÕES V1


//COMEÇO DAS NOVAS FUNÇÕES V2
#define MAX_SIZE 100

bool verificar_violacoes(char **tabuleiro, int m, int n) {
        ...
        if (opcao == 1) {
            ...
            do {
                ...
                if (entrada[0] == '0' && entrada[1] == '\n') {
                    ...
                    verificar_violacoes(tabuleiro, linhas, colunas);
                } else {
